...
Route::get('/artigo', 'PodcastsController@artigo');
Route::post('/artigo', 'PodcastsController@artigo');
Route::get('/artigo/{id}', 'PodcastsController@artigofull');
Route::post('/artigo/{id}', 'PodcastsController@artigofull');
...
Route::get('/podcast/atualizar', 'PodcastsController@atiualziar');
